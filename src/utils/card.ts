export const siswacard = async function (
    model: any,
    reqbody: any,
    search_list: string[],
    sort_by: any
    ...
    if (search !== "" && search_list !== null) {
        countWhere.OR = search_list.map((item) => ({
...
export const siswacardregistrasi = async function (
    model: any,
    reqbody: any,
    search_list: string[],
    sort_by: any
...
export const siswacardverif = async function (
    model: any,
    reqbody: any,
    search_list: string[],
    sort_by: any
...
export const card = async function (
    model: any,
    reqbody: any,
    search_list: string[],
    sort_by: any
