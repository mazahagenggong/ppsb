...
const DownloadFormulir = () => {
    ...
    if (error) {
        LoadingTimer("Bukti Pendaftaran Tidak Valid", "error", 1500);
        return (
    ...
    if (orang) {
        LoadingTimer("Bukti Pendaftaran Valid", "success", 1500);
    }
                    ...
                    <div className="flex-col">
                        <div className="card w-full md:w-1/2">
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-sm-12">
                                        <h2 className="card-title">Bukti Pendaftaran Valid</h2>
                                        <button
