                    ...
                    <center>
                        <div className="flex-col">
                                            ...
                                            <button
                                                ...
                                                onClick={async () => {
                                                    try {
                                                        ...
                                                        // await createPDF(data, dataSantri.id);
                                                        await LoadingTimer("Masih Simulasi.", "success", 5000);
                                                    } catch (e) {
                            ...
                            <center className={"mb-3"}>
                                <CldImage alt={"foto"} src={dataSantri.biodata.foto} width={300} height={300}/>
                            </center>
                            <div className="card w-full md:w-1/2">
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-sm-12">
                                            ...
                                            <div className="table-responsive">
                                                <table className="table">
                                                    ...
                                                    <tr>
                                                        <td>Jenis Kelamin</td>
                                                        <td>: {dataSantri.jk === "lk" ? "Laki - laki" : "Perampuan"}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>TTL</td>
                                                        <td>: {dataSantri.biodata.tempat_lahir}, {formatDate(dataSantri.biodata.tanggal)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Provinsi</td>
                                                    ...
                                                    <tr>
                                                        <td>Detail Alamat</td>
                                                        <td>: {`RT ${dataSantri.alamat.rt} RW ${dataSantri.alamat.rw}, ${dataSantri.alamat.alamat}`}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Nomor HP</td>
                                                        <td>: {dataSantri.hp}</td>
                                            ...
                                            <div className="table-responsive">
                                                <table className="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: {dataSantri.panitia ? `Via Panitia (${dataSantri.panitia.nama})` : "Transfer"}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>Terverifikasi</td>
                                                        <td>: {formatDate(dataSantri.pembayaran.updated_at)}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
